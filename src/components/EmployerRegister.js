...
return errors
  ...
  return (
    <div className="container p-5" style={{ "marginTop": "5%" }}>
      <h1 className='text-center'>Employer Register Form </h1>
          ...
          <p></p>
          <div className="mb-3">
            <label htmlFor="exampleInputEmail1" className="form-label">Company's Email address</label>
          ...
          <p></p>
          <div className="mb-3">
            <label htmlFor="exampleInputEmail1" className="form-label">Company's Phone</label>
